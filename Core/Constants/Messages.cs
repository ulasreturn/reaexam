...
public static class Messages
{
  ...
  public static string? SuccessfullyCreatedEntity { get; set; }
  public static string? SuccessfullyUpdatedEntity { get; set; }
  public static string? SuccessfullyDeletedEntity { get; set; }
}
